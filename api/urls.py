...
router.register(r'weixin', views.WeixinViewSet, base_name='weixin')
...
urlpatterns = (
    ...
    url(r'^edit-user-info$', views.edit_user_info, name='edit_user_info'),
    ...
    url(r'^weixin-qrconnect-url$', views.weixin_qrconnect_url, name='weixin_qrconnect_url'),
